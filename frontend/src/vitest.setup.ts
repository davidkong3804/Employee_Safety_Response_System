    ...
    resources: {
      en: {
        translation: {
          ...
          'reminder.banner': 'Reminder for event: {{event}}',
          'reminder.bannerMulti': '{{count}} pending reminders',
          'reminder.modalTitle': 'Reminder',
          'reminder.modalBody': 'You have a pending reminder for {{event}}.',
          'reminder.modalBodyMulti': 'You have {{count}} pending reminders.',
          'reminder.modalGoReport': 'Report Now',
          'reminder.modalLater': 'Later',
        },
      },
    },
